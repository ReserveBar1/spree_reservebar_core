  ...
  */
  function deployQZ() {
    var attributes = {id: "qz", code:'qz.PrintApplet.class', 
      archive:'/assets/admin/qz-print.jar', width:55, height:55};
    var parameters = {jnlp_href: '/assets/admin/qz-print_jnlp.jnlp', 
      cache_option:'plugin', disable_logging:'false', 
      initial_focus:'false'};
    if (deployJava.versionCheck("1.7+") == true) {}
    else if (deployJava.versionCheck("1.6+") == true) {
      attributes['archive'] = '/assets/admin/qz-print.jar';
