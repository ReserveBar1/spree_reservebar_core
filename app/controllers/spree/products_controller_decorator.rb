Spree::ProductsController.class_eval do
  ...
  def adroll_feed
    ...
    product_permalinks << ['the-macallan-sherry-oak-12-years-old','the-macallan-rare-cask','absolut-elyx-2','absolut-elyx-custom-engraved-bottle-1','hennessy-vs','hennessy-x-dot-o','hennessy-xo-custom-engraved-bottle','hennessy-privilege-vsop-limited-edition-2015','hennessy-paradis-1','hennessy-paradis-imperial']
